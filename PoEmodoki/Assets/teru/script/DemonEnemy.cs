...
{
    StateMachine<DemonEnemy> stateMachine;
    ...
    void Start()
    {
        ...
        stateMachine = new StateMachine<DemonEnemy>(this);
    ...
    private class IdleState : StateMachine<DemonEnemy>.StateBase
    {
        float cDis;
    ...
    private class ChaseState : StateMachine<DemonEnemy>.StateBase
    {
        public override void OnStart()
        {
            Owner.navMeshAgent.isStopped = false;
    ...
    private class DeadState : StateMachine<DemonEnemy>.StateBase
    {
        public override void OnStart()
        {
