...
public class MiniBoss1 : Enemy
{
    ...
    [SerializeField] EnemyStatus MiniBossStatus;
...
#if UNITY_EDITOR
    private SerializedObject seliarizeMiniBossStatus;
#endif
    ...
    void Start()
    {
        MaxHP = MiniBossStatus.EnemyHp;
        currentHP = MaxHP;
        AttackRange = MiniBossStatus.EnemyLength;
        AttackSpeed = MiniBossStatus.EnemyAtkSpeed;
        Strength = MiniBossStatus.EnemyAtk;
        MoveSpeed = MiniBossStatus.EnemySpeed;
    ...
    private class ChaseState : StateMachine<MiniBoss1>.StateBase
    {
    ...
    private class VigilanceState : StateMachine<MiniBoss1>.StateBase
    {
        float time;
        float mTime;
    ...
    private class AttackState : StateMachine<MiniBoss1>.StateBase
    {
        public override void OnStart()
        {
    ...
    private class RotateState : StateMachine<MiniBoss1>.StateBase
    {
        public override void OnStart()
        {
            Owner.navMeshAgent.isStopped = true;
    ...
    private class SkillState : StateMachine<MiniBoss1>.StateBase
    {
    ...
    private class StiffnessState : StateMachine<MiniBoss1>.StateBase
    {
        float time;
        public override void OnStart()
        {
    ...
    private class HitState : StateMachine<MiniBoss1>.StateBase
    {
        public override void OnStart()
        {
    ...
    private class DeadState : StateMachine<MiniBoss1>.StateBase
    {
        public override void OnStart()
        {
    ...
    {
        if (MiniBossStatus == null)
        {
            return null;
        }

        if (seliarizeMiniBossStatus == null || seliarizeMiniBossStatus.targetObject != MiniBossStatus)
        {
            seliarizeMiniBossStatus = new SerializedObject(MiniBossStatus);
            return seliarizeMiniBossStatus;
        }
